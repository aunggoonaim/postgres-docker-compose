...
--
ALTER TABLE amphures ADD PRIMARY KEY (id);
...
--
ALTER TABLE geographies ADD PRIMARY KEY (id);
...
--
ALTER TABLE amphures ALTER COLUMN id SET NOT NULL; 
ALTER TABLE amphures ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY;
--
...
--
ALTER TABLE geographies ALTER COLUMN id SET NOT NULL;
ALTER TABLE geographies ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY;
--
-- AUTO_INCREMENT for table provinces
--
ALTER TABLE provinces ALTER COLUMN id SET NOT NULL;
ALTER TABLE provinces ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY;

-- CREATE SEQUENCE amphures_seq_id OWNED BY amphures.id;
ALTER SEQUENCE amphures_id_seq RESTART WITH 1007;

-- CREATE SEQUENCE districts_seq_id OWNED BY districts.id;
ALTER SEQUENCE districts_id_seq RESTART WITH 8914;

-- CREATE SEQUENCE geographies_seq_id OWNED BY geographies.id;
ALTER SEQUENCE geographies_id_seq RESTART WITH 7;

-- CREATE SEQUENCE provinces_seq_id OWNED BY provinces.id;
ALTER SEQUENCE provinces_id_seq RESTART WITH 78;